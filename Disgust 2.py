...
to_send = [
   [[2500, 3000, 2500, 1000], 500],
    [[2300, 1000, 2500, 2000], 1000],
    [[2400, 2000, 2300, 1000], 1000],
    [[2450, 2000, 2800, 1000], 1000],
    [[2500, 2000, 2400, 1000], 1000],
    [[2550, 2000, 2700, 1000], 1000],
    [[2500, 2000, 2500, 1000], 1000],
   
   
]

# The head tilting forward, then whilst coming back up is gong left, right, left, right, and then centre.
...
positiony_max = 2900  # Maximum allowed positiony value
