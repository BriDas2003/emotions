...
to_send = [
    ...
    [[2700, 2000, 2500, 2000], 1000],
    [[2700, 2000, 2200, 4000], 1000],
    [[2700, 2000, 2900, 4000], 1000],
    [[2700, 2000, 2200, 4000], 1000],
    [[2700, 2000, 2900, 4000], 1000],
    [[2700, 2000, 2200, 4000], 1000],
    [[2700, 2000, 2500, 1000], 1000],
]
#Head tilting backwards and then going left, right, left, right, left, and then centre.
